...
ui_var_info_t  num_info[VAR_MAX] =
{
    ...
    //务必注意最小值不要大于最大值
    {0, 0, 0, CAR_CTRL_MAX, {0,0}},         //变量 car_ctrl，
    {0, 0, 0, 100, {64, 0}},                //变量 var1，
    {0, 0, 0, 100, {0, 17}},                //变量 var2，
    {0, 0, 0, 300, {64, 17}},               //变量 var3，
    {0, 0, 0, 300, {0, 34}},                //变量 var4，
    {0, 0, 0, 65540, {64, 34}},             //变量 var5，
    {0, 0, 0, 65540, {0, 51}}               //变量 var6，
};
